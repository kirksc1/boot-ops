...
class ItemValidationInitiatedEventTest {
    ...
    public void testConstructor_whenItemNull_thenThrowIllegalArgumentException() {
        IllegalArgumentException thrown = Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new ItemValidationInitiatedEvent(this, null, result);
        });
    ...
    public void testConstructor_whenResultNull_thenThrowIllegalArgumentException() {
        IllegalArgumentException thrown = Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new ItemValidationInitiatedEvent(this, item, null);
        });
    ...
    public void testConstructor_whenConstructed_thenGettersReadable() {
        ItemValidationInitiatedEvent event = new ItemValidationInitiatedEvent(this, item, result);
